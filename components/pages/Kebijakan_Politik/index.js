...
import kebijakanpolitik from "../../../data/artikel/kebijakanpolitik";

const kebpolitik = ({ navigation, route }) => {
  return (
    <View>
      <View
        style={{
      ...
      >
        ...
        >
          <Text style={styles.title}>Kebijakan Politik</Text>
        </TouchableOpacity>
      </View>
